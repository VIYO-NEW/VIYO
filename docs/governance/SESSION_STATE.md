...
*2026-05-19 PASTE BLOCK H landed — R22 v2 v2.0 → v2.0.1 amendment (header bump + §9.3 sites list new row for auth.ts bootstrap Path B). B-0.02 v1.0 substrate prerequisites COMPLETE.*
