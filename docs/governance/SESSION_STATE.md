...
*2026-05-20 NOTION_CATALOGING_RULES.md re-synced against live Notion (workspace reorg + hygiene audit). D-1/D-2 verifiers + grep -viE fix all merged (PR #37/#38/#39); git hooks re-installed — D-1/D-2 enforcement operational for the first time. Next: viyo-zcbr-architect skill v1.0.7.*
